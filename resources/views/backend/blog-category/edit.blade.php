  ...
  <div class="row gutters">
    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
      <div class="card m-0">
        <div class="card-header">
          <div class="card-title">Update BlogCategory</div>
        </div>
        <div class="card-body">
          @if ($errors->any())
          ...
          {{ session('msg') }}
          @endif
          <form  action="{{ route('backend.blog-category.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="form-group">
                  <label for="inputSubject" class="col-form-label">BlogCategory Status</label>
    ...
    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
      <div class="table-container">
        <div class="t-header">All BlogCategory</div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    ...
                    <a href="{{ route("backend.blog-category.edit", $value->id) }}"><span class="btn btn-warning"><i class="icon-edit1"></i></span></a>&nbsp&nbsp&nbsp
                        @endif
                    ...
                    <span class=""><a href="#" onclick="event.preventDefault();
                      ...
                      @endif
                    <form id="logout-form-{{ $value->id }}" action="{{ route('backend.blog-category.destroy') }}" method="POST" style="display: none;">
                      @csrf
