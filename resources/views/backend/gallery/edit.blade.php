    ...
    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
      <div class="card m-0">
        ...
        <div class="card-body">
          ...
          {{ session('msg') }}
          @endif
          <form  action="{{ route('backend.gallery.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="form-group">
                  ...
                  <img src="{{ asset("assets/images/gallery/{$selected->id}.{$selected->image}") }}" alt="No Image" id="imgload" width="80"/>
                </div>
                <div class="form-group">
