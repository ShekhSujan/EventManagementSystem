          ...
          <form action="{{ route('backend.slider.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="form-group">
                  <label for="inputSubject" class="col-form-label">Image  [1920*895]</label>
                ...
                <div class="form-group">
                  ...
                  <textarea name="short_details" class="form-control" placeholder="Enter Short Description"></textarea>
                </div>
                <div class="form-group">
