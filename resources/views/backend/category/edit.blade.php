  ...
  <div class="row gutters">
    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
      <div class="card m-0">
        ...
        <div class="card-body">
          <a href="{{ route('backend.category.create') }}" class="btn btn-info">Add New</a>
          @if ($errors->any())
            ...
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="form-group">
                  ...
                  <img src="{{ asset("assets/images/category/{$selected->id}.{$selected->image}") }}" alt="No Image" id="imgload" width="80"/>
                </div>
                <div class="form-group">
