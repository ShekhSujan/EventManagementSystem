    ...
    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
      <div class="card m-0">
        ...
        <div class="card-body">
          ...
          {{ session('msg') }}
          @endif
          <form action="{{ route('backend.sponsor.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row gutters">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group">
                  <label for="inputSubject" class="col-form-label">Sponsor Title</label>
                  <input type="text" name="title" class="form-control" placeholder="Enter Sponsor Title">
                </div>
                <div class="form-group">
                  <label for="inputSubject" class="col-form-label">Sponsor Image</label>
